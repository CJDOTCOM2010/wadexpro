...
/// BrandConfig — Dynamic Branding Singleton (Driver App)
///
...
/// reference across the driver app.
///
...
class BrandConfig {
  ...
  static void fromJson(Map<String, dynamic>? data) {
    ...
    appIconUrl = data['driver_app_icon_url'] ?? data['app_icon_url'];
    ...
    splashBackgroundColor = data['driver_splash_background'] ?? data['splash_background_color'];
