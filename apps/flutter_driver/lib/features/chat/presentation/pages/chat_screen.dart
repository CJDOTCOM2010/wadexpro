...
class _ChatScreenState extends ConsumerState<ChatScreen> {
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            const Text('Customer • Active Ride', style: TextStyle(fontSize: 12, color: Colors.white70)),
          ],
        ),
  ...
  Widget _buildQuickReplies() {
    final replies = ["I've arrived", "Where are you?", "Traffic is heavy", "OK"];
    return SizedBox(
      height: 36,
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return ActionChip(
            ...
            labelStyle: const TextStyle(fontSize: 12, color: AppColors.primaryNavy),
            backgroundColor: AppColors.accent.withOpacity(0.1),
            padding: EdgeInsets.zero,
            onPressed: () {
              ref.read(chatProvider(widget.rideId).notifier).sendMessage(replies[index]);
            },
          );
        },
      ),
