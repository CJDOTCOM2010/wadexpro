...
class ChatNotifier extends StateNotifier<ChatState> {
  ...
  Future<void> loadHistory() async {
    ...
    try {
      ...
      // Note: We need current user ID for 'isMe'. In a real app, inject it from AuthProvider.
      // For now, we'll assume a dummy comparison or handle it in the factory if we had the ID.
