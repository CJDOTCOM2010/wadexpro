...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('Could not load driver onboarding',
  ...
  Widget _buildGlobalOverlays(OnboardingConfig config) {
    ...
    final textColor = isDarkLayout ? Colors.white : AppColors.primaryNavy;
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        _ContentBlock(data: data, align: Alignment.bottomLeft, onAction: onAction),
      ],
    );
  }
}
    ...
    return Column(
      children: [
        ...
        Expanded(
          ...
          child: Container(
            color: Colors.white,
            child: _ContentBlock(data: data, textColor: AppColors.primaryNavy, onAction: onAction),
          ),
        ),
      ],
    );
      ...
      children: [
        ...
        Center(
          child: Container(
            ...
            child: _ContentBlock(data: data, textColor: AppColors.primaryNavy, centered: true, onAction: onAction),
          ),
        ),
      ],
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _ContentBlock(data: data, textColor: AppColors.primaryNavy, centered: true, onAction: onAction),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Spacer(),
          _ContentBlock(data: data, centered: true, onAction: onAction),
      ...
      children: [
        ...
        Center(
          child: Container(
            ...
            child: _ContentBlock(data: data, centered: true, onAction: onAction),
          ),
        ),
      ],
    );
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        Positioned.fill(child: Container(color: AppColors.primaryNavy.withValues(alpha: 0.7))),
        _ContentBlock(data: data, align: Alignment.centerLeft, onAction: onAction),
      ],
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _ContentBlock(data: data, textColor: AppColors.primaryNavy, onAction: onAction),
