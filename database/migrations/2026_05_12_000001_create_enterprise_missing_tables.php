...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('otp_verifications', function (Blueprint $table) {
            ...
            $table->string('type', 30)->default('login'); // login, registration, password_reset, phone_verify
        ...
        Schema::create('audit_logs', function (Blueprint $table) {
            ...
            $table->foreignUuid('user_id')->nullable()->constrained()->nullOnDelete();
            $table->string('user_type', 20)->nullable(); // admin, driver, customer
            $table->string('event', 50);                 // created, updated, deleted, login, etc.
        ...
        Schema::create('driver_documents', function (Blueprint $table) {
            ...
            $table->string('document_type', 50);         // national_id, drivers_license, insurance, etc.
        ...
        Schema::create('vehicle_types', function (Blueprint $table) {
            ...
            $table->json('service_types')->nullable();   // ['ride', 'courier', 'charter']
        ...
        Schema::create('vehicle_documents', function (Blueprint $table) {
            ...
            $table->string('document_type', 50);        // roadworthy, insurance, registration, inspection
            $table->string('document_number')->nullable();
            $table->text('file_url');
        ...
        Schema::create('ride_cancellations', function (Blueprint $table) {
            ...
            $table->string('cancelled_by_type', 20);    // customer, driver, admin
            $table->string('reason_code', 60)->nullable();
            $table->text('reason_text')->nullable();
            $table->boolean('penalty_applied')->default(false);
            $table->decimal('penalty_amount', 10, 2)->default(0);
            $table->string('penalty_charged_to', 20)->default('none'); // customer, driver, none
        ...
        Schema::create('wallet_transactions', function (Blueprint $table) {
            ...
            $table->string('category', 40);             // top_up, ride_payment, payout, refund, bonus, penalty
        ...
        Schema::create('faqs', function (Blueprint $table) {
            ...
            $table->string('audience', 20)->default('all'); // all, customer, driver
            $table->boolean('is_active')->default(true);
            $table->unsignedSmallInteger('sort_order')->default(0);
            $table->timestamps();
        ...
        Schema::create('banners', function (Blueprint $table) {
            ...
            $table->string('placement', 40)->default('home');    // home, promotions, dashboard
            $table->string('audience', 20)->default('all');      // all, customer, driver
            $table->boolean('is_active')->default(true);
