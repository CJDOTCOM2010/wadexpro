...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <a href="{{ route('orchestrator.support') }}" class="bg-white rounded-2xl border border-gray-100 p-4 text-center hover:border-accent hover:shadow-md transition-all group">
