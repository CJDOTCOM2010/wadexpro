    ...
    <aside class="bg-brand text-white flex flex-col shrink-0 h-screen border-r border-white/10 transition-all duration-500 ease-in-out relative z-50 overflow-hidden"
        ...
        <nav class="flex-1 py-8 px-5 space-y-8 overflow-y-auto overflow-x-hidden transition-all duration-500" :class="sidebarOpen ? 'opacity-100' : 'opacity-0 translate-x-10'">
            ...
            <div class="space-y-1 border-t border-white/5 pt-6">
                <p class="px-4 text-[10px] font-black text-white/30 uppercase tracking-[0.2em] mb-4">System & Settings</p>
                ...
                <a href="{{ route('orchestrator.settings.assets') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-lg hover:bg-white/5 transition group {{ request()->routeIs('orchestrator.settings.assets') ? 'bg-white/10 text-accent shadow-lg shadow-black/20' : 'text-white/60 hover:text-white' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    <span class="text-sm font-semibold whitespace-nowrap">Gallery Assets</span>
                </a>

                <!-- Settings Sub-section -->
                <div class="pt-2 space-y-1">
                    <a href="{{ route('orchestrator.settings') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-lg hover:bg-white/5 transition group {{ request()->routeIs('orchestrator.settings*') && !request()->routeIs('orchestrator.settings.assets') ? 'bg-white/10 text-accent shadow-lg shadow-black/20' : 'text-white/60 hover:text-white' }}">
                        ...
                        <span class="text-sm font-semibold whitespace-nowrap">Settings Hub</span>
                    </a>
                    <a href="{{ route('orchestrator.settings.branding') }}" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-white/5 transition group {{ request()->routeIs('orchestrator.settings.branding') ? 'bg-white/10 text-accent' : 'text-white/40 hover:text-white' }}">
                        <svg class="w-4 h-4 shrink-0 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        <span class="text-xs font-semibold whitespace-nowrap">Branding</span>
                    </a>
                    <a href="{{ route('orchestrator.settings.payments') }}" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-white/5 transition group {{ request()->routeIs('orchestrator.settings.payments') ? 'bg-white/10 text-accent' : 'text-white/40 hover:text-white' }}">
                        <svg class="w-4 h-4 shrink-0 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                        <span class="text-xs font-semibold whitespace-nowrap">Payments</span>
                    </a>
                    <a href="{{ route('orchestrator.settings.notifications') }}" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-white/5 transition group {{ request()->routeIs('orchestrator.settings.notifications') ? 'bg-white/10 text-accent' : 'text-white/40 hover:text-white' }}">
                        <svg class="w-4 h-4 shrink-0 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
                        <span class="text-xs font-semibold whitespace-nowrap">Notifications</span>
                    </a>
                    <a href="{{ route('orchestrator.settings.security') }}" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-white/5 transition group {{ request()->routeIs('orchestrator.settings.security') ? 'bg-white/10 text-accent' : 'text-white/40 hover:text-white' }}">
                        <svg class="w-4 h-4 shrink-0 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                        <span class="text-xs font-semibold whitespace-nowrap">Security</span>
                    </a>
                    <a href="{{ route('orchestrator.settings.backups') }}" class="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-white/5 transition group {{ request()->routeIs('orchestrator.settings.backups') ? 'bg-white/10 text-accent' : 'text-white/40 hover:text-white' }}">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative" @click.away="userMenuOpen = false">
                    ...
                    <div x-show="userMenuOpen" 
                        ...
                        <a href="{{ route('orchestrator.driver.management') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-surface transition text-sm font-semibold text-gray-700">
