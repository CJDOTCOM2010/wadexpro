    ...
    <form action="{{ route('orchestrator.settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-lg settings-card">
            ...
            <div class="p-5 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Brand Name (Full)</label>
                        <input type="text" name="settings[brand_name]" value="{{ getSetting('brand_name', 'WADEXPRO') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="e.g. WADEXPRO">
                        <p class="text-[10px] text-gray-400 mt-1.5">Splash screens and headers</p>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Brand Short Name</label>
                        <input type="text" name="settings[brand_short_name]" value="{{ getSetting('brand_short_name', 'WADEX') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="e.g. WADEX">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Customer App Name</label>
                        <input type="text" name="settings[customer_app_display_name]" value="{{ getSetting('customer_app_display_name', 'WADEXPRO') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all">
                        <p class="text-[10px] text-gray-400 mt-1.5">App title on device</p>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Driver App Name</label>
                        <input type="text" name="settings[driver_app_display_name]" value="{{ getSetting('driver_app_display_name', 'WADEXPRO Driver') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all">
                        <p class="text-[10px] text-gray-400 mt-1.5">Driver app title on device</p>
                    </div>
                </div>

                <div>
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Brand Tagline</label>
                    <input type="text" name="settings[brand_tagline]" value="{{ getSetting('brand_tagline', 'Move. Deliver. Thrive.') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="e.g. Move. Deliver. Thrive.">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="email" name="settings[support_email]" value="{{ getSetting('support_email', 'ops@wadexpro.com') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Support Phone</label>
                        <input type="text" name="settings[brand_support_phone]" value="{{ getSetting('brand_support_phone', '') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="+233 XX XXX XXXX">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-lg settings-card">
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Brand Logo -->
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Splash Screen Logo</label>
                    ...
                    <!-- App Icon -->
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">App Icon (Launcher)</label>
                        <div class="flex items-start gap-4">
                ...
                <div class="mt-6 pt-5 border-t border-gray-100">
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Splash Screen Background</label>
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Play Store Link</label>
                            <input type="url" name="settings[play_store_customer_link]" value="{{ getSetting('play_store_customer_link', '') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="https://play.google.com/store/apps/...">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">App Store Link</label>
                            <input type="url" name="settings[app_store_customer_link]" value="{{ getSetting('app_store_customer_link', '') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="https://apps.apple.com/app/...">
                        </div>
                    </div>
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Play Store Link</label>
                            <input type="url" name="settings[play_store_driver_link]" value="{{ getSetting('play_store_driver_link', '') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="https://play.google.com/store/apps/...">
                        </div>
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">App Store Link</label>
                            <input type="url" name="settings[app_store_driver_link]" value="{{ getSetting('app_store_driver_link', '') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="https://apps.apple.com/app/...">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-lg settings-card">
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">{{ $color['label'] }}</label>
                        <div class="flex items-center gap-3 bg-gray-50 rounded-lg p-2 border border-gray-200">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-lg settings-card">
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Customer App Min Version</label>
                        <input type="text" name="settings[min_customer_app_version]" value="{{ getSetting('min_customer_app_version', '1.0.0') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="1.0.0">
                        <p class="text-[10px] text-gray-400 mt-1.5">Users below this version will be forced to update</p>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Driver App Min Version</label>
                        <input type="text" name="settings[min_driver_app_version]" value="{{ getSetting('min_driver_app_version', '1.0.0') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all" placeholder="1.0.0">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-lg settings-card">
            ...
            <div class="p-5">
                <div class="max-w-md">
                    <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Enterprise Name</label>
                    <input type="text" name="settings[enterprise_name]" value="{{ getSetting('enterprise_name', 'WADEXPRO Logistics Hub') }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 px-4 text-sm text-gray-700 focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/10 outline-none transition-all">
                </div>
            </div>
        </div>
