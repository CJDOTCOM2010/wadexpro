...
.toggle-switch .toggle-slider::before {
    transform: translateX(calc(var(--toggle-width) - var(--toggle-height) - 2px));
}
...
.settings-card:hover {
    border-color: rgba(28, 44, 68, 0.15);
}
</style>
...
<div class="p-6 lg:p-8 max-w-6xl mx-auto">
    ...
    <form action="{{ route('orchestrator.settings.update') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Google Maps -->
            <div class="bg-white rounded-xl border border-gray-200 settings-card">
                <div class="p-5 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <label class="toggle-switch relative inline-flex items-center cursor-pointer">
                        ...
                        <div class="toggle-slider w-[52px] h-7 bg-gray-200 peer-focus:ring-2 peer-focus:ring-blue-100 rounded-full transition-colors relative">
                            <span class="absolute left-1 top-1 text-[10px] font-medium text-gray-400 peer-checked:text-white transition-colors z-10">OFF</span>
                            <span class="absolute right-1 top-1 text-[10px] font-medium text-white opacity-0 peer-checked:opacity-100 transition-opacity z-10">ON</span>
                        </div>
                    </label>
                </div>
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="settings[google_maps_key]" value="{{ getSetting('google_maps_key') ? '••••••••••••' : '' }}" placeholder="Enter your API key" class="custom-select w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-blue-500 focus:bg-white transition-all">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-3">Enabled Features</label>
            ...
            <div class="bg-white rounded-xl border border-gray-200 settings-card">
                <div class="p-5 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <label class="toggle-switch relative inline-flex items-center cursor-pointer">
                        ...
                        <div class="toggle-slider w-[52px] h-7 bg-gray-200 peer-focus:ring-2 peer-focus:ring-gray-100 rounded-full transition-colors relative">
                            <span class="absolute left-1 top-1 text-[10px] font-medium text-gray-400 peer-checked:text-white transition-colors z-10">OFF</span>
                            <span class="absolute right-1 top-1 text-[10px] font-medium text-white opacity-0 peer-checked:opacity-100 transition-opacity z-10">ON</span>
                        </div>
                    </label>
                ...
                <div class="p-5">
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Access Token</label>
                        <div class="relative">
                            <input type="password" name="settings[mapbox_key]" value="{{ getSetting('mapbox_key') ? '••••••••••••' : '' }}" placeholder="Enter your access token" class="custom-select w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-gray-900 focus:bg-white transition-all">
                            <div class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            </div>
                        </div>
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        ...
                        <input type="text" name="settings[default_latitude]" value="{{ getSetting('default_latitude', '5.6037') }}" class="w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Longitude</label>
                        <input type="text" name="settings[default_longitude]" value="{{ getSetting('default_longitude', '-0.1870') }}" class="w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Zoom Level</label>
                        @php $currentZoom = getSetting('default_zoom_level', '14'); @endphp
                        <select name="settings[default_zoom_level]" class="custom-select w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Map Style</label>
                        @php $currentStyle = getSetting('default_map_style', 'streets'); @endphp
                        <select name="settings[default_map_style]" class="custom-select w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Distance Unit</label>
                        @php $currentUnit = getSetting('distance_unit', 'km'); @endphp
                        <select name="settings[distance_unit]" class="custom-select w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
        ...
        <div class="bg-white rounded-xl border border-gray-200 settings-card">
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Default Country</label>
                        @php $currentCountry = getSetting('geocoding_country', 'GH'); @endphp
                        <select name="settings[geocoding_country]" class="custom-select w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
                    ...
                    <div>
                        ...
                        <select name="settings[geocoding_language]" class="custom-select w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
        ...
        <div class="bg-white rounded-xl border border-gray-200 settings-card">
            <div class="px-5 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                ...
                <label class="toggle-switch relative inline-flex items-center cursor-pointer">
                    ...
                    <div class="toggle-slider w-[52px] h-7 bg-gray-200 peer-focus:ring-2 peer-focus:ring-brand/20 rounded-full transition-colors relative">
                        <span class="absolute left-1 top-1 text-[10px] font-medium text-gray-400 peer-checked:text-white transition-colors z-10">OFF</span>
                        <span class="absolute right-1 top-1 text-[10px] font-medium text-white opacity-0 peer-checked:opacity-100 transition-opacity z-10">ON</span>
                    </div>
                </label>
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">GPS Update Interval</label>
                        <div class="relative">
                            <input type="number" name="settings[gps_update_interval]" value="{{ getSetting('gps_update_interval', '5') }}" min="1" max="60" class="w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 pr-10 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
                            <span class="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">sec</span>
                        </div>
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Location History</label>
                        <div class="relative">
                            <input type="number" name="settings[location_history_days]" value="{{ getSetting('location_history_days', '30') }}" min="1" max="365" class="w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 pr-10 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
                            <span class="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400">days</span>
                        </div>
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Search Radius</label>
                        <div class="relative">
                            <input type="number" name="settings[default_search_radius]" value="{{ getSetting('default_search_radius', '5') }}" min="1" max="50" class="w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 px-3 pr-10 text-sm text-gray-700 focus:border-brand focus:bg-white transition-all">
